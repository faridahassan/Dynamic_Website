...
class Image extends \AdminBundle\Entity\Image implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'url', '' . "\0" . 'AdminBundle\\Entity\\Image' . "\0" . 'file', 'item', 'event');
        }
    ...
    public function compress($src, $dest, $quality)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'compress', array($src, $dest, $quality));

        return parent::compress($src, $dest, $quality);
    }
